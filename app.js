...
const client_component_lookup = {".svelte/build/runtime/internal/start.js": "start-6e6980cb.js", "src/routes/index.svelte": "pages/index.svelte-8e58143c.js"};
const manifest = {
  ...
  routes: [
    {
      ...
      css: ["assets/start-ed3f047c.css", "assets/pages/index.svelte-294d5a62.css"],
      js: ["start-6e6980cb.js", "chunks/index-a6b5a79d.js", "pages/index.svelte-8e58143c.js"]
    }
  ]
};
...
var Card_svelte = "#title.svelte-cvkbvv{text-decoration:none}strong.svelte-cvkbvv{font-size:1.4em}";
const css$2 = {
  code: "#title.svelte-cvkbvv{text-decoration:none}strong.svelte-cvkbvv{font-size:1.4em}",
  map: '{"version":3,"file":"Card.svelte","sources":["Card.svelte"],"sourcesContent":["<svelte:head>\\n  <link\\n    rel=\\"stylesheet\\"\\n    href=\\"https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.4.1/components/card.min.css\\"\\n    integrity=\\"sha512-u5E5vOHVsB0blcZniDNfaRkTfqdgjxIgLX17YlG0vjQyos7Z7b1BXLuhHZbF2JOVRrfNNd8P6v7fw87JaFw/Rg==\\"\\n    crossorigin=\\"anonymous\\"\\n  />\\n</svelte:head>\\n\\n<div class=\\"ui card\\">\\n  <div class=\\"image\\">\\n    <img\\n      src=\\"https://pngimg.com/uploads/running_shoes/running_shoes_PNG5827.png\\"\\n      alt=\\"cart\\"\\n    />\\n  </div>\\n  <div class=\\"content\\">\\n    <a class=\\"header\\" href=\\"/\\" id=\\"title\\">Kristy</a>\\n    <div class=\\"meta\\">\\n      <strong>$10</strong>\\n    </div>\\n    <div class=\\"description\\">Kristy is an art director living in New York.</div>\\n  </div>\\n</div>\\n\\n<style>\\n  #title {\\n    text-decoration: none;\\n  }\\n  strong {\\n    font-size: 1.4em;\\n  }\\n</style>\\n"],"names":[],"mappings":"AA0BE,MAAM,cAAC,CAAC,AACN,eAAe,CAAE,IAAI,AACvB,CAAC,AACD,MAAM,cAAC,CAAC,AACN,SAAS,CAAE,KAAK,AAClB,CAAC"}'
};
const Card = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$2);
  return `${$$result.head += `<link rel="${"stylesheet"}" href="${"https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.4.1/components/card.min.css"}" integrity="${"sha512-u5E5vOHVsB0blcZniDNfaRkTfqdgjxIgLX17YlG0vjQyos7Z7b1BXLuhHZbF2JOVRrfNNd8P6v7fw87JaFw/Rg=="}" crossorigin="${"anonymous"}" data-svelte="svelte-1tisrhk">`, ""}

<div class="${"ui card"}"><div class="${"image"}"><img src="${"https://pngimg.com/uploads/running_shoes/running_shoes_PNG5827.png"}" alt="${"cart"}"></div>
  <div class="${"content"}"><a class="${"header svelte-cvkbvv"}" href="${"/"}" id="${"title"}">Kristy</a>
    <div class="${"meta"}"><strong class="${"svelte-cvkbvv"}">$10</strong></div>
    <div class="${"description"}">Kristy is an art director living in New York.</div></div>
</div>`;
});
var index_svelte = ".card-cont.svelte-popp1r{padding:1em;display:flex}";
const css$1 = {
  code: ".card-cont.svelte-popp1r{padding:1em;display:flex}",
  map: '{"version":3,"file":"index.svelte","sources":["index.svelte"],"sourcesContent":["<script>\\n  import Card from \\"$lib/Card.svelte\\";\\n</script>\\n\\n<div class=\\"card-cont\\">\\n  <Card />\\n</div>\\n\\n<style>\\n  .card-cont {\\n    padding: 1em;\\n    display: flex;\\n  }\\n</style>\\n"],"names":[],"mappings":"AASE,UAAU,cAAC,CAAC,AACV,OAAO,CAAE,GAAG,CACZ,OAAO,CAAE,IAAI,AACf,CAAC"}'
};
const Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$1);
  return `<div class="${"card-cont svelte-popp1r"}">${validate_component(Card, "Card").$$render($$result, {}, {}, {})}
</div>`;
});
...
var Navbar_svelte = "nav.svelte-1w04dpb.svelte-1w04dpb{cursor:pointer;background-color:#34495e;align-items:center;display:flex;justify-content:space-between}.left-side.svelte-1w04dpb.svelte-1w04dpb{padding:0.7em}.nav-item.svelte-1w04dpb.svelte-1w04dpb{list-style-type:none;margin:10px;text-decoration:none;color:white;font-size:1.1em;transition:ease 200ms}.nav-item.svelte-1w04dpb.svelte-1w04dpb:hover{color:#f5f934}.cart.svelte-1w04dpb.svelte-1w04dpb{display:flex;padding:0.2em;justify-content:center;align-items:center}.cart.svelte-1w04dpb i.svelte-1w04dpb{margin-right:10px;color:#9f1def}.right-side.svelte-1w04dpb div.svelte-1w04dpb{font-size:1.4em;color:yellow;text-align:center}@media screen and (max-width: 310px){nav.svelte-1w04dpb.svelte-1w04dpb{flex-direction:column;justify-content:center;align-items:center}}";
const css = {
  code: "nav.svelte-1w04dpb.svelte-1w04dpb{cursor:pointer;background-color:#34495e;align-items:center;display:flex;justify-content:space-between}.left-side.svelte-1w04dpb.svelte-1w04dpb{padding:0.7em}.nav-item.svelte-1w04dpb.svelte-1w04dpb{list-style-type:none;margin:10px;text-decoration:none;color:white;font-size:1.1em;transition:ease 200ms}.nav-item.svelte-1w04dpb.svelte-1w04dpb:hover{color:#f5f934}.cart.svelte-1w04dpb.svelte-1w04dpb{display:flex;padding:0.2em;justify-content:center;align-items:center}.cart.svelte-1w04dpb i.svelte-1w04dpb{margin-right:10px;color:#9f1def}.right-side.svelte-1w04dpb div.svelte-1w04dpb{font-size:1.4em;color:yellow;text-align:center}@media screen and (max-width: 310px){nav.svelte-1w04dpb.svelte-1w04dpb{flex-direction:column;justify-content:center;align-items:center}}",
  map: '{"version":3,"file":"Navbar.svelte","sources":["Navbar.svelte"],"sourcesContent":["<script>\\n  export let cart = 0;\\n</script>\\n\\n<svelte:head>\\n  <link\\n    rel=\\"stylesheet\\"\\n    href=\\"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css\\"\\n  />\\n</svelte:head>\\n\\n<nav>\\n  <div class=\\"left-side\\">\\n    <a class=\\"nav-item\\" href=\\"/\\">Home</a>\\n    <a class=\\"nav-item\\" href=\\"/\\">Offers</a>\\n    <a class=\\"nav-item\\" href=\\"/\\">Latest</a>\\n  </div>\\n  <div class=\\"right-side\\">\\n    <div class=\\"cart\\">\\n      <i class=\\"fa fa-shopping-cart\\" style=\\"font-size:48px;\\" />\\n      <div class=\\"cart-count\\">{cart}</div>\\n    </div>\\n  </div>\\n</nav>\\n\\n<style>\\n  nav {\\n    cursor: pointer;\\n    background-color: #34495e;\\n    align-items: center;\\n    display: flex;\\n    justify-content: space-between;\\n  }\\n  .left-side {\\n    padding: 0.7em;\\n  }\\n  .nav-item {\\n    list-style-type: none;\\n    margin: 10px;\\n    text-decoration: none;\\n    color: white;\\n    font-size: 1.1em;\\n    transition: ease 200ms;\\n  }\\n  .nav-item:hover {\\n    color: #f5f934;\\n  }\\n  .cart {\\n    display: flex;\\n    padding: 0.2em;\\n    justify-content: center;\\n    align-items: center;\\n  }\\n  .cart i {\\n    margin-right: 10px;\\n    color: #9f1def;\\n  }\\n  .right-side div {\\n    font-size: 1.4em;\\n    color: yellow;\\n    text-align: center;\\n  }\\n\\n  @media screen and (max-width: 310px) {\\n    nav {\\n      flex-direction: column;\\n      justify-content: center;\\n      align-items: center;\\n    }\\n  }\\n</style>\\n"],"names":[],"mappings":"AA0BE,GAAG,8BAAC,CAAC,AACH,MAAM,CAAE,OAAO,CACf,gBAAgB,CAAE,OAAO,CACzB,WAAW,CAAE,MAAM,CACnB,OAAO,CAAE,IAAI,CACb,eAAe,CAAE,aAAa,AAChC,CAAC,AACD,UAAU,8BAAC,CAAC,AACV,OAAO,CAAE,KAAK,AAChB,CAAC,AACD,SAAS,8BAAC,CAAC,AACT,eAAe,CAAE,IAAI,CACrB,MAAM,CAAE,IAAI,CACZ,eAAe,CAAE,IAAI,CACrB,KAAK,CAAE,KAAK,CACZ,SAAS,CAAE,KAAK,CAChB,UAAU,CAAE,IAAI,CAAC,KAAK,AACxB,CAAC,AACD,uCAAS,MAAM,AAAC,CAAC,AACf,KAAK,CAAE,OAAO,AAChB,CAAC,AACD,KAAK,8BAAC,CAAC,AACL,OAAO,CAAE,IAAI,CACb,OAAO,CAAE,KAAK,CACd,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,AACrB,CAAC,AACD,oBAAK,CAAC,CAAC,eAAC,CAAC,AACP,YAAY,CAAE,IAAI,CAClB,KAAK,CAAE,OAAO,AAChB,CAAC,AACD,0BAAW,CAAC,GAAG,eAAC,CAAC,AACf,SAAS,CAAE,KAAK,CAChB,KAAK,CAAE,MAAM,CACb,UAAU,CAAE,MAAM,AACpB,CAAC,AAED,OAAO,MAAM,CAAC,GAAG,CAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AACpC,GAAG,8BAAC,CAAC,AACH,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,MAAM,CACvB,WAAW,CAAE,MAAM,AACrB,CAAC,AACH,CAAC"}'
};
...
<nav class="${"svelte-1w04dpb"}"><div class="${"left-side svelte-1w04dpb"}"><a class="${"nav-item svelte-1w04dpb"}" href="${"/"}">Home</a>
    <a class="${"nav-item svelte-1w04dpb"}" href="${"/"}">Offers</a>
    <a class="${"nav-item svelte-1w04dpb"}" href="${"/"}">Latest</a></div>
  <div class="${"right-side svelte-1w04dpb"}"><div class="${"cart svelte-1w04dpb"}"><i class="${"fa fa-shopping-cart svelte-1w04dpb"}" style="${"font-size:48px;"}"></i>
      <div class="${"cart-count svelte-1w04dpb"}">${escape(cart)}</div></div></div>
</nav>`;
});
